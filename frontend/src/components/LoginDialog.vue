...
<template>
  <Dialog v-model:open="isOpen">
    ...
    <DialogContent class="sm:max-w-[500px]">
      <DialogHeader>
        <DialogTitle class="text-2xl font-bold text-center">Дьоллоох буоллун!</DialogTitle>
      </DialogHeader>

      <Tabs default-value="login" class="w-full">
        <TabsList class="grid w-full grid-cols-2">
          <TabsTrigger value="login">Киириһии</TabsTrigger>
          <TabsTrigger value="register">Бэлиэтэниһии</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="login">
          <form @submit.prevent="login" class="space-y-4 mt-4">
            <div class="space-y-2">
              <Label for="login-username">Аат-суол (Username)</Label>
              <Input
                id="login-username"
            ...
            <div class="space-y-2">
              <Label for="login-password">Киирии тыла (Пароль)</Label>
              <Input
                id="login-password"
            ...
            <Button type="submit" class="w-full" :disabled="authStore.isLoading">
              {{ authStore.isLoading ? 'Күүтүү...' : 'Киириһии' }}
            </Button>
          </form>
        </TabsContent>
        ...
        <TabsContent value="register">
          <form @submit.prevent="register" class="space-y-4 mt-4">
            <div class="space-y-2">
              <Label for="register-username">Аат-суол (Username)</Label>
              <Input
            ...
            <div class="space-y-2">
              <Label for="register-password">Киирии тыла (Пароль)</Label>
              <Input
            ...
            <div class="space-y-2">
              <Label for="register-confirm">Бигэргэтии (Подтвердите)</Label>
              <Input
                id="register-confirm"
            ...
            <Button type="submit" class="w-full" :disabled="authStore.isLoading">
              {{ authStore.isLoading ? 'Күүтүү...' : 'Бэлиэтэниһии' }}
            </Button>
          </form>
        </TabsContent>
      </Tabs>
